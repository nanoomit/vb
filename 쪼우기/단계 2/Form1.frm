...
Private Sub Command2_Click()
    ...
    For i = 1 To 2
        UserSum = UserSum + User(i, 1)
        ComputerSum = ComputerSum + Computer(i, 1)
    Next i
    
    Dim UserMod As Integer
    Dim ComputerMod As Integer
    
    UserMod = UserSum Mod 10
    ComputerMod = ComputerSum Mod 10
    
    If UserMod > ComputerMod Then
        MsgBox ("님이 이겼습니다")
    ElseIf UserMod = ComputerMod Then
        MsgBox ("비겼습니다")
    Else
        MsgBox ("컴퓨터가  이겼습니다")
    End If
