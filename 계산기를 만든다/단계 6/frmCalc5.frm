...
On Error GoTo 0
    ...
    If Not IsNumeric(txtValue1.Text) Or Trim(txtValue1.Text) = "" Then
        MsgBox "숫자를 입력해야 합니다"
    ...
    If Not IsNumeric(txtValue2.Text) Or Trim(txtValue2.Text) = "" Then
        MsgBox "숫자를 입력해야 합니다"
