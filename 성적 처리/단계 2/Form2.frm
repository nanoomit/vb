...
Private Sub cmdScoreAdd_Click()
    ...
    Irum(Seq) = Trim(txtIrum.Text)
    Guk(Seq) = CInt(txtGuk.Text)
    Math(Seq) = CInt(txtMath.Text)
    Sahe(Seq) = CInt(txtSahe.Text)
    Sci(Seq) = CInt(txtSci.Text)
    ...
    Form1.MSFlexGrid1.Text = Irum(Seq)
    
    Form1.MSFlexGrid1.Col = 3
    Form1.MSFlexGrid1.Text = Guk(Seq)
    
    Form1.MSFlexGrid1.Col = 4
    Form1.MSFlexGrid1.Text = Math(Seq)
    
    Form1.MSFlexGrid1.Col = 5
    Form1.MSFlexGrid1.Text = Sahe(Seq)

    Form1.MSFlexGrid1.Col = 6
    Form1.MSFlexGrid1.Text = Sci(Seq)
